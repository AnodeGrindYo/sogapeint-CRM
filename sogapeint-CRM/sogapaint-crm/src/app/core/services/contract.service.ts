...
export class ContractService {
    ...
    */
    ...
    /**
    * Met à jour le statut "processed" d'une observation.
    * 
    * @param observationId L'identifiant de l'observation.
    * @param processed Le nouveau statut "processed".
    * @returns Un Observable contenant la réponse du serveur.
    */
    updateObservationProcessedStatus(observationId: string, processed: boolean): Observable<any> {
        return this.http.put<any>(`${environment.apiUrl}/api/contracts/observation/${observationId}/processed`, { processed });
    }

    /**
    * Met à jour le statut "processed" d'un incident.
    * 
    * @param incidentId L'identifiant de l'incident.
    * @param processed Le nouveau statut "processed".
    * @returns Un Observable contenant la réponse du serveur.
    */
    updateIncidentProcessedStatus(incidentId: string, processed: boolean): Observable<any> {
        return this.http.put<any>(`${environment.apiUrl}/api/contracts/incident/${incidentId}/processed`, { processed });
    }
}
