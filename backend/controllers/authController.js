...
exports.getInvoices = async (req, res) => {
  ...
  try {
      const contracts = await ContractModel.find(
          { 'file.name': /^invoice_/ }, // Filtrer pour les fichiers dont le nom commence par 'invoice_'
          { file: 1, _id: 0 } // Ne récupérer que le champ 'file'
      ).sort({ 'file.uploadDate': -1 }); // Trier par date de téléversement décroissante
      ...
      // Extraire toutes les factures et les trier par date
